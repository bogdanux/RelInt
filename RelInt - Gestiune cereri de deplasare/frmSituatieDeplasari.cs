        ...
        public DataTable GenerareTabel()
        {
            ...
            using (OdbcConnection conexiune = new OdbcConnection(sircon_RelIntDB))
            {
                ...
                using (OdbcCommand comanda = new OdbcCommand())
                {
                    ...
                    comanda.CommandText = "SELECT nrinregistrareodc AS \"Nr. înregistrare (cereri)\", nrinregistrareod AS \"Nr. UAIC\", nrinregistrareodnou AS \"Nr. UAIC Nou\", dataod AS \"Data BECA\", dataodnoua AS \"Data BECA Nouă\", subsemnatulod AS \"Beneficiar\", graddidacticod AS \"Grad didactic\", facultateaod AS \"Facultatea\", taraod AS \"Țara\", localitateaod AS \"Localitatea\", scopod AS \"Scop\", precizariscopod AS \"Precizări Scop\", institutiaod AS \"Instituția\", datainceputod AS \"Data început\", datasfarsitod AS \"Data sfârșit\", rutaod AS \"Ruta\", platitortranspod AS \"Finanțare transport\", platitorintretinereod AS \"Finanțare subzistență\", nrzilediurnaod AS \"Nr. zile diurnă\", diurnaod AS \"Diurnă\", monedadiurnaod AS \"Monedă diurnă\", nrzilecazareod AS \"Nr. zile cazare\", cazareod AS \"Cazare\", monedacazareod AS \"Monedă cazare\", taxadeparticipareod AS \"Taxă de participare\", monedataxadeparticipareod AS \"Monedă taxă de participare\", taxadevizaetcod AS \"Taxă de viză + Asigurare medicală\", monedataxadevizaetcOD AS \"Monedă taxă de viză\", totalod AS \"Total\", numerpod AS \"Nume Rector/Prorector\", dfcod AS \"Director Financiar Contabil\", cpnumeprojod AS \"Nume Proiect\", cpgraddidacticod AS \"Grad didactic\", cpnumecoordod AS \"Nume coordonator proiect\" FROM ordinedeplasare WHERE scopod = ?";
