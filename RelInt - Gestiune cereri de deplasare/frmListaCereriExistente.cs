        ...
        public void PopularedgvVizualizareTot()
        {
            ...
            {           // Comanda
                using (OdbcCommand comanda_dgvAfisareVT = new OdbcCommand())
                {
                    ...
                    comanda_dgvAfisareVT.CommandText = "SELECT nrinregistrarec as \"Nr. înregistrare\", datac AS \"Data înregistrare\", subsemnatulc AS \"Subsemnatul\", graddidacticc AS \"Grad Didactic\", facultateac AS \"Facultatea\", departamentulc AS \"Departamentul\", localitateac AS \"Localitatea\", tarac AS \"Țara\", scopc AS \"Acțiunea\", institutiac AS \"Instituția\", datainceputc AS \"Între data\", datasfarsitc AS \"și data\", rutac AS \"Ruta\", mijtransc AS \"Mijloc de transport\", platitortranspc AS \"Plătitor transport\", platitorintretinerec AS \"Plătitor întreținere\", nrzilediurnac AS \"Nr. Zile Diurnă\", diurnac AS \"Diurnă\", monedadiurnac AS \"Moneda Diurnă\", nrzilecazarec AS \"Nr. Zile Cazare\", cazarec AS \"Cazare\", monedacazarec AS \"Monedă Cazare\", taxadeparticiparec AS \"Taxă de participare\", monedataxadeparticiparec AS \"Monedă taxă de participare\", taxadevizaetcc AS \"Taxă de viză\", monedataxadevizaetcc AS \"Monedă taxă de viză + asigurare medicală\", totalc AS \"Total\", ambasadac AS \"Ambasadă\", nedeterminatac AS \"Perioadă nedeterminată?\", determinatac AS \"Perioadă determinată?\", decanc AS \"Decan\", vizacontac AS \"Viza Contabilitate\", admsefbirouc AS \"Administrator șef\", sefdepartamentdirc AS \"Șef departament\", vizaruc AS \"Viza RU\", tiozc AS \"Trecut în ordinea de zi?\" FROM cereri";
